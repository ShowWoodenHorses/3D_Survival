...
public class RangedAttackStateEnemy : StateEnemy
{
    ...
    public RangedAttackStateEnemy(ManGun manGun, Transform playerPos, Transform bulletPos, ObjectPoolController poolController,
